...
The app reads from and writes to a file 'todos.txt' to manage the to-do list.

Functions:
- add_todo: Adds a new to-do from the input field to the list and saves it.
- get_todos: Retrieves the list of to-dos from the file.
- write_todos: Writes the current list of to-dos back to the file.
"""
